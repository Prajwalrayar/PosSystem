              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">+91 63618 39277</p>
                    <p className="opacity-90">+91 86603 35208</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">Alliance University</p>
                    <p className="opacity-90">Bangalore, Karnataka 562106</p>
                  </div>
                </div>
