...
const CustomerLookupPage = () => {
  ...
  const handleAddPoints = async () => {
    ...
    dispatch(clearLoyaltyPointsState());
    ...
    try {
      ...
      if (typeof result?.pointsAfter === "number") {
        setSelectedCustomer((prev) => {
          ...
          return {
            ...prev,
            loyaltyPoints: result.pointsAfter,
          };
        });
      }
      ...
      toast({
        ...
        description: result?.message || "Loyalty points updated successfully.",
      });
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <AddPointsDialog
        ...
        note={pointsNote}
        onNoteChange={setPointsNote}
        onAddPoints={handleAddPoints}
        isLoading={loyaltyPointsStatus.isLoading}
      />
