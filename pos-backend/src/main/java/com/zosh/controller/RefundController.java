...
public class RefundController {
    ...
    public ResponseEntity<List<RefundDTO>> getRefundsByBranch(@PathVariable("branchId") Long branchId) {
    ...
    public ResponseEntity<List<RefundDTO>> getRefundsByShift(@PathVariable("shiftReportId") Long shiftReportId) {
    ...
    // ✅ 7. Get refund by ID
    @GetMapping("/{id}")
    public ResponseEntity<RefundDTO> getRefundById(@PathVariable("id") Long id) throws ResourceNotFoundException {
    ...
    // ✅ 8. Delete refund
    @DeleteMapping("/{id}")
    public ResponseEntity<?> deleteRefund(@PathVariable("id") Long id) throws ResourceNotFoundException {
