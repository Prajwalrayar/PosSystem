...
public class InventoryController {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('STORE_MANAGER')")
    public ResponseEntity<Void> delete(@PathVariable("id") Long id) throws AccessDeniedException, UserException {
    ...
    public ResponseEntity<List<InventoryDTO>> getByBranch(@PathVariable("branchId") Long branchId) {
