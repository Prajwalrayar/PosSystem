...
public class CategoryController {
	...
	public ResponseEntity<List<CategoryDTO>> getCategories(@PathVariable("storeId") Long storeId) {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('ROLE_STORE_MANAGER', 'ROLE_STORE_ADMIN')")
	public ResponseEntity<Void> deleteCategory(@PathVariable("id") Long id) throws UserException {
