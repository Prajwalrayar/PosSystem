...
import com.zosh.payload.StoreAnalysis.RecentBranchSalesDTO;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    List<Order> findByCashierIdIs(Long cashierId);
    ...
    @Modifying
    @Query("UPDATE Order o SET o.cashier = null WHERE o.cashier.id = :cashierId")
    int clearCashierById(@Param("cashierId") Long cashierId);
...
""")
    ...
    @Query("""
        SELECT new com.zosh.payload.StoreAnalysis.RecentBranchSalesDTO(
            b.id,
            b.name,
            SUM(o.totalAmount),
            MAX(o.createdAt)
    ...
    """)
    List<RecentBranchSalesDTO> findRecentBranchSales(@Param("storeAdminId") Long storeAdminId);
