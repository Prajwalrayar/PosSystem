...
public class StoreMapper {
        ...
        public static StoreDTO toDto(Store store) {
            return StoreDTO.builder()
                    ...
                    .commissionRate(store.getCommissionRate() == null ? BigDecimal.ZERO : store.getCommissionRate())
        ...
        public static Store toEntity(StoreDTO dto, User storeAdmin) {
            return Store.builder()
                    ...
                    .commissionRate(dto.getCommissionRate() == null ? BigDecimal.ZERO : dto.getCommissionRate())
                    .build();
        }
    }
